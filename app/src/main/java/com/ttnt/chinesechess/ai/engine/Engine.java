...
/** Plays the machine's side with negamax, alpha-beta or the optimized search. */
public final class Engine {
    ...
    /** {@code GameSearch.search(problem)}, the way the textbook calls it. */
    private static Result run(GameSearch.Problem<Move> problem, int depth) {
